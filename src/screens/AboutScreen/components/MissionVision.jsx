...
const Data = [
  {
    title: "Mission",
    desc: `  We are on a mission to improve the mind health and wellbeing of individuals in
                                        Africa.
  ...
  {
    title: "Vision",
    desc: ` To create multiple tech enabled support systems to guide individuals on the
                                        continent to
                                        greater experiences of wellbeing from a world that demands so much.`,
  },
  {
    title: "Why Choose Us",
    desc: ` We believe that everyone deserves to live their most optimal life, despite
                                        life’s
